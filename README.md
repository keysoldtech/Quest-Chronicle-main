...
- **v4.3.11** (Current) - **Layout:** Game screen fills the viewport with **no full-page scroll** (internal panels scroll). **Desktop action bar** sits inside the main column (not fixed to viewport). **Short/wide windows** (e.g. height ≤720px) use the **mobile tabbed** game UI like narrow viewports. `isDesktop()` matches width ≥1025 and height ≥721.
