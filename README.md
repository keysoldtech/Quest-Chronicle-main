...
- **v4.2.4** (Current) - Multiplayer sync: emit state before `turnStarted`; action bar + `turnPopupReady` from game state; log toasts after paint; respect `isPaused` for actions
