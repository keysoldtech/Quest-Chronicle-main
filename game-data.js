...
// --- 6.3. Spell Cards ---
// effect.damageType (when type is damage): used for armor resistances (fire, cold, lightning, thunder, acid, poison, necrotic, radiant, force).
// Armor hooks in server.js: Arcanist's Weave, Spellward Plate, Sylvan Shroud, Spiritweave Robes, Toughened Hides, Earth-Forged Mail, Wyrmscale Mail, Crystal Hide (non-magical physical only).
const spellCards = [
    // Level 1
    { name: "Acid Burst", type: "Spell", level: 1, apCost: 1, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "1d6", damageType: "acid", target: "aoe", description: "Deals 1d6 acid damage to each creature in a 5-foot radius sphere at Far range." } },
    { name: "Cinder Shot", type: "Spell", level: 1, apCost: 1, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "1d10", damageType: "fire", target: "any-monster", description: "Deals 1d10 fire damage at Far range. 33% chance to set the target On Fire.", chanceToApplyStatus: { status: 'On Fire', chance: 0.33 } } },
    { name: "Flame Fan", type: "Spell", level: 1, apCost: 1, class: ["Mage"], effect: { type: "damage", dice: "3d6", damageType: "fire", target: "aoe", description: "Deals 3d6 fire damage in a 15-foot cone. (DEX save DC 13 for half). 25% chance to set targets On Fire.", chanceToApplyStatus: { status: 'On Fire', chance: 0.25 } } },
    ...
    { name: "Force Darts", type: "Spell", level: 1, apCost: 1, class: ["Mage"], effect: { type: "damage", dice: "1d4+1", damageType: "force", target: "multi-monster", description: "Deals 1d4+1 force damage to up to three targets at Far range." } },
    { name: "Frost Beam", type: "Spell", level: 1, apCost: 1, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "1d8", damageType: "cold", status: "Slowed", duration: 2, target: "any-monster", description: "Deals 1d8 cold damage and reduces target's speed by 10 feet until the start of your next turn." } },
    ...
    { name: "Jolt Touch", type: "Spell", level: 1, apCost: 1, class: ["Mage"], effect: { type: "damage", dice: "1d8", damageType: "lightning", status: "Stunned", duration: 2, target: "any-monster", description: "Deals 1d8 lightning damage. Target can't take reactions until the start of its next turn." } },
    ...
    { name: "Radiant Strike", type: "Spell", level: 1, apCost: 1, class: ["Cleric"], effect: { type: "damage", dice: "4d6", damageType: "radiant", target: "any-monster", description: "Deals 4d6 radiant damage. The next attack roll against the target has advantage." } },
    ...
    { name: "Shockwave", type: "Spell", level: 1, apCost: 1, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "2d8", damageType: "thunder", target: "aoe", description: "Deals 2d8 thunder damage in a 15-foot cube and pushes creatures 10 feet away. (CON save DC 13)." } },
    ...
    { name: "Toxic Cloud", type: "Spell", level: 1, apCost: 1, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "1d12", damageType: "poison", target: "any-monster", description: "Deals 1d12 poison damage at Close range. (CON save DC 13)." } },
    ...
    { name: "Inferno Rays", type: "Spell", level: 2, apCost: 2, class: ["Mage"], effect: { type: "damage", dice: "2d6", damageType: "fire", target: "multi-monster", description: "You create three rays of fire, each dealing 2d6 fire damage." } },
    { name: "Lunar Ray", type: "Spell", level: 2, apCost: 2, class: ["Cleric", "Ranger"], effect: { type: "damage", dice: "2d10", damageType: "radiant", target: "aoe", description: "A beam of light deals 2d10 radiant damage to any creature that enters it or starts its turn there for 1 minute." } },
    ...
    { name: "Sonic Burst", type: "Spell", level: 2, apCost: 2, class: ["Mage", "Ranger"], effect: { type: "damage", dice: "3d8", damageType: "thunder", target: "aoe", description: "Deals 3d8 thunder damage in a 10-foot radius sphere. (CON save DC 14 for half)." } },
    ...
    { name: "Inferno Sphere", type: "Spell", level: 3, apCost: 3, class: ["Mage"], effect: { type: "damage", dice: "6d6", damageType: "fire", target: "aoe", description: "Deals 6d6 fire damage in a 20-foot radius sphere. (DEX save DC 15 for half)." } },
    { name: "Life Transfer", type: "Spell", level: 3, apCost: 3, class: ["Cleric"], effect: { type: "heal", damageType: "necrotic", description: "You take 4d8 necrotic damage, and one creature you touch regains twice that amount of hit points." } },
    { name: "Thunder Stroke", type: "Spell", level: 3, apCost: 3, class: ["Cleric", "Ranger"], effect: { type: "damage", dice: "6d6", damageType: "lightning", target: "any-monster", description: "Deals 6d6 lightning damage. If the target is a construct, it has disadvantage on attack rolls for 1 minute." } },
...
// --- 7. MONSTER DATA ---
const allMonsters = [
    { name: "Goblin Archer", type: "Monster", maxHp: 12, attackBonus: 4, requiredRollToHit: 13, effect: { dice: "1d6+2", damageType: "piercing" }, xpValue: 10, stats: { str: 1, dex: 3, con: 1, int: 0, wis: 1, cha: 0 } },
    { name: "Dire Wolf", type: "Monster", maxHp: 20, attackBonus: 5, requiredRollToHit: 14, effect: { dice: "2d6+3", damageType: "piercing" }, xpValue: 15, stats: { str: 3, dex: 2, con: 2, int: 0, wis: 1, cha: 0 } },
    { name: "Giant Spider", type: "Monster", maxHp: 18, attackBonus: 3, requiredRollToHit: 12, effect: { dice: "1d8+1", damageType: "piercing", description: "On hit, target must succeed a DC 11 CON save or be Poisoned." }, xpValue: 12, stats: { str: 2, dex: 3, con: 2, int: 0, wis: 0, cha: 0 } },
    { name: "Orc Brute", type: "Monster", maxHp: 25, attackBonus: 5, requiredRollToHit: 15, effect: { dice: "2d8+3", damageType: "bludgeoning" }, xpValue: 20, stats: { str: 4, dex: 1, con: 3, int: 0, wis: 0, cha: 1 } },
    { name: "Hobgoblin Soldier", type: "Monster", maxHp: 22, attackBonus: 4, requiredRollToHit: 16, effect: { dice: "1d10+2", damageType: "slashing" }, xpValue: 18, stats: { str: 3, dex: 2, con: 2, int: 1, wis: 1, cha: 1 } },
    { name: "Gelatinous Cube", type: "Monster", maxHp: 40, attackBonus: 4, requiredRollToHit: 12, effect: { dice: "2d6", damageType: "acid", description: "On hit, the target is Engulfed." }, xpValue: 30, stats: { str: 2, dex: 0, con: 4, int: 0, wis: 0, cha: 0 } },
    { name: "Skeleton Guard", type: "Monster", maxHp: 15, attackBonus: 2, requiredRollToHit: 13, effect: { dice: "1d6", damageType: "slashing" }, xpValue: 8, stats: { str: 1, dex: 2, con: 1, int: 0, wis: 0, cha: 0 } },
    { name: "Cave Bear", type: "Monster", maxHp: 30, attackBonus: 6, requiredRollToHit: 14, effect: { dice: "2d10+4", damageType: "slashing" }, xpValue: 25, stats: { str: 4, dex: 1, con: 3, int: 0, wis: 1, cha: 0 } },
    { name: "Stone Golem", type: "Monster", maxHp: 50, attackBonus: 6, requiredRollToHit: 17, effect: { dice: "3d8+4", damageType: "bludgeoning" }, xpValue: 50, isBoss: true, stats: { str: 5, dex: 0, con: 5, int: 0, wis: 0, cha: 0 } },
